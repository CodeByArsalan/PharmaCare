...
namespace PharmaCare.Infrastructure.Migrations
{
    ...
    [Migration("20251230070739_AddDoubleEntryAccountingSystem")]
    partial class AddDoubleEntryAccountingSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaCare.Domain.Models.Inventory.StockTransfer", b =>
                {
                    b.HasOne("PharmaCare.Domain.Models.Stores.Store", "DestinationStore")
                        .WithMany()
                        .HasForeignKey("DestinationStore_ID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PharmaCare.Domain.Models.Stores.Store", "SourceStore")
                        .WithMany()
