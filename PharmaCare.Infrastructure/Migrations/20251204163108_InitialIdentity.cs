        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebPagesWebPageID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WebPageUrlID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    WebPage_ID = table.Column<int>(type: "int", nullable: false),
                    WebPagesWebPageID = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserWebPages", x => x.UserWebPageID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserWebPages_SystemUser_ID",
                table: "UserWebPages",
                column: "SystemUser_ID");

            migrationBuilder.CreateIndex(
                name: "IX_UserWebPages_WebPage_ID",
                table: "UserWebPages",
                column: "WebPage_ID");
