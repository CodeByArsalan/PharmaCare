...
namespace PharmaCare.Infrastructure.Migrations
{
    ...
    [Migration("20260820174905_HardeningSweep4")]
    partial class HardeningSweep4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaCare.Domain.Entities.Configuration.Product", b =>
                {
                    ...
                    b.ToTable("Products", null, t =>
                        {
                            t.HasCheckConstraint("CK_Products_UnitsInPack_Positive", "[UnitsInPack] > 0");
                        });
                });
            ...
            modelBuilder.Entity("PharmaCare.Domain.Entities.Configuration.SubCategory", b =>
                {
                    ...
                    b.HasIndex("Pharmacy_ID", "Category_ID", "Name")
                        .IsUnique();

                    b.ToTable("SubCategories", (string)null);
                });

            modelBuilder.Entity("PharmaCare.Domain.Entities.Finance.CreditNote", b =>
                {
            ...
            modelBuilder.Entity("PharmaCare.Domain.Entities.Finance.Payment", b =>
                {
                    ...
                    b.ToTable("Payments", null, t =>
                        {
                            t.HasCheckConstraint("CK_Payments_PaymentType_Valid", "[PaymentType] IN ('RECEIPT','PAYMENT','REFUND','ADJUSTMENT')");
                        });
                });

            modelBuilder.Entity("PharmaCare.Domain.Entities.Finance.PaymentAllocation", b =>
                {
                    ...
                    b.Property<int?>("SupplierCreditNote_ID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SupplierCreditNote_ID");
            ...
            modelBuilder.Entity("PharmaCare.Domain.Entities.Security.User", b =>
                {
                    ...
                    b.Property<string>("PermissionsStamp")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("PharmaCare.Domain.Entities.Finance.PaymentAllocation", b =>
                {
                    b.HasOne("PharmaCare.Domain.Entities.Finance.CreditNote", "CreditNote")
                        .WithMany("PaymentAllocations")
                        .HasForeignKey("CreditNote_ID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("PharmaCare.Domain.Entities.Finance.Payment", "Payment")
                        .WithMany("PaymentAllocations")
                    ...
                    b.HasOne("PharmaCare.Domain.Entities.Finance.SupplierCreditNote", "SupplierCreditNote")
                        .WithMany()
                        .HasForeignKey("SupplierCreditNote_ID")
                        .OnDelete(DeleteBehavior.Cascade);
